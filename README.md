...
<head>
    ...
    <meta name="description" content="Brader-Berbagi - Berita, informasi, dan update terkini dari seluruh dunia">
    <meta name="keywords" content="Brader, berita, info terkini, update, liputan">
    <meta name="author" content="Brader Berbagi 2025">
    <title>Brader</title>
    <style>
        body {
    ...
    <main>
        ...
        <section id="news">
            ...
            <article>
                ...
                <p>Challenge ini berhasil menarik lebih dari 15.000 peserta dalam dua minggu pertama, menunjukkan antusiasme tinggi masyarakat dalam menggabungkan hiburan, kreativitas, dan semangat berbagi secara digital.</p>
            </article>
        </section>
